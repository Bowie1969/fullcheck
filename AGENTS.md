# FullCheck — project context for Codex

This file is read automatically by Codex in this repo, on any machine.
It exists because the `~/.Codex` auto-memory is machine-local and does not sync
